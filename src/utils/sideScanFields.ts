export const sideScanPerformaceCardFields = [
  ...
  {
    name: "survey_platform_performance.horizontal_field_of_view",
    label: "horizontal_field_of_view",
    type: "number",
  },
  {
    name: "survey_platform_performance.vertical_field_of_view",
  ...
  {
    name: "survey_platform_performance.beamwidth",
    label: "beamwidth",
    type: "number",
  },
  {
    name: "survey_platform_performance.depression_angle",
    label: "depression_angle",
    type: "number",
  },
  {
    name: "survey_platform_performance.max_range_of_sss",
...
export const lever_arm_measuresFields = [
  {
    name: "lever_arm_measures_between.ford_gnss_usbl_transducer",
  ...
  {
    name: "lever_arm_measures_between.std_ins_of_the_usbl_the_gnss",
