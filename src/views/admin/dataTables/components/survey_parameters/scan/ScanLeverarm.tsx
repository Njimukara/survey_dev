...
export default function ScanLeverarm(props: { [x: string]: any }) {
  const { ...rest } = props;
  ...
  return (
    <Card borderRadius="10px" p="4" boxShadow="lg" w="100%" {...rest}>
      ...
      <Card p="4" mb="6" boxShadow="lg">
        ...
        <Flex gap="2">
          <FormControl mb="4">
            <FormLabel fontSize="sm">GNSS and USBL transducer (m)</FormLabel>
            <Input
          ...
          <FormControl mb="4">
            <FormLabel fontSize="sm">INS of the USBL and GNSS (m)</FormLabel>
            <Input
              color={textColorSecondary}
              borderRadius="10px"
              fontSize="sm"
